...
module "cc_asg" {
  ...
  source                    = "../modules/terraform-zscc-2region-asg1v2-aws"
  name_prefix               = var.name_prefix
  resource_tag              = var.name_suffix
  global_tags               = local.global_tags
...
module "cc_asg2" {
  ...
  source                    = "../modules/terraform-zscc-2region-asg2v2-aws"
  name_prefix               = var.name_prefix
  resource_tag              = var.name_suffix
  global_tags               = local.global_tags
...
module "asg_lambda" {
  ...
  source                  = "../modules/terraform-zscc-2region-asg-lambda1v2-aws"
  name_prefix             = var.name_prefix
  resource_tag            = var.name_suffix
  global_tags             = local.global_tags
...
module "asg_lambda2" {
  ...
  source                  = "../modules/terraform-zscc-2region-asg-lambda2v2-aws"
  name_prefix             = var.name_prefix
  resource_tag            = var.name_suffix
  global_tags             = local.global_tags
  cc_vm_prov_url          = var.cc_vm_prov_url
