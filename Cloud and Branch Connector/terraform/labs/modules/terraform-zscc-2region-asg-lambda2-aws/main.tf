...
resource "aws_iam_role" "asg_lambda_iam_role" {
  name = "${var.name_prefix}-asg-lambda2-iam-role-${var.resource_tag}"
...
resource "aws_iam_policy" "lambda_get_secrets_policy" {
  ...
  name        = "${var.name_prefix}-lambda2-get-secrets-${var.resource_tag}"
...
resource "aws_iam_policy" "lambda_autoscale_lifecycle_policy" {
  ...
  name        = "${var.name_prefix}-asg-lambda2-aslc-${var.resource_tag}"
...
resource "aws_iam_policy" "lambda_metrics_policy" {
  ...
  name        = "${var.name_prefix}-asg-lambda2-get-metrics-${var.resource_tag}"
...
resource "aws_iam_policy" "lambda_logs_policy" {
  ...
  name        = "${var.name_prefix}-asg-lambda2-send-logs-${var.resource_tag}"
...
resource "aws_lambda_function" "asg_lambda_function" {
  function_name    = "${var.name_prefix}_asg_lambda2_function_${var.resource_tag}"
...
resource "aws_cloudwatch_event_rule" "asg_cloudwatch_scheduler_event_rule" {
  name                = "${var.name_prefix}-cc-asg-scheduled2-event-rule-${var.resource_tag}"
...
resource "aws_cloudwatch_event_rule" "asg_cloudwatch_lifecycle_event_rule" {
  name        = "${var.name_prefix}-cc-asg-lifecycle2-event-rule-${var.resource_tag}"
...
resource "aws_cloudwatch_event_rule" "asg_cloudwatch_instance_termination_event_rule" {
  name        = "${var.name_prefix}-cc-asg-instance-termination2-event-rule-${var.resource_tag}"
